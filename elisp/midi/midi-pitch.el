(cl-defun midi-chrome-from-byte (pitch-byte) (mod pitch-byte 12))
;;(midi-chrome-from-byte 100) ==> 4
(cl-defun midi-octave-byte (pitch-byte) (1- (/ pitch-byte 12)))
;;(midi-octave-byte 100) ==> 7

(cl-defun midi-split-pitch-byte (pitch-byte)
...
(cl-defun midi-split-pitch-string (pitch-string)
...
(cl-defun midi-pitch-byte (pitch-string)
