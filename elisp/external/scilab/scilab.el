...
;; Created: 03.01 2001
;; Version: 2.1.27quad [Vincent Belaiche evolution, 22/06/2009]
...
(defconst scilab-mode-version "2.1.27quad(V. Belaiche)"
...
;;(remove-hook 'comint-output-filter-functions 'shell-strip-ctrl-m)
...
;;(remove-hook 'comint-output-filter-functions 'scilab-output-garbage-filter)
