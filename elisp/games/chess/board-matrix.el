...
(cl-defun print-board-positions (positions &optional (symbols '(?X ?·)))
  "Obsolete?"
...
(cl-defun print-board-squares (squares &optional (symbols '(?X ?·)))
  "Obsolete?"
