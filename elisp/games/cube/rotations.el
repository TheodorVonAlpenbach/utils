...
(defun perm-inverse (x)
  (project x x))
;;(perm-inverse '(0 2 1))

(defun perm-reflect (x)
...
(defun perm-U (x n) (rotate-list x (* 3 n)))
;;(perm-U (0-n 12) 1)

(defun perm-M (x) (perm-swap x '(1 7)))
(defun perm-S (x) (perm-swap x '(4 10)))
(defun perm-F (x) (perm-swap x '(0 3) '(11 2)))
(defun perm-B (x) (perm-swap x '(5 8) '(6 9)))

(defun perm-NE (x) (perm-swap x '(0 6) '(5 11)))
(defun perm-NW (x) (perm-U (perm-NE (perm-U x 1)) -1))
;;(perm-NW (0-n 12))
