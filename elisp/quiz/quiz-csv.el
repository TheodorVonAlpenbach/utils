...
(cl-defun quiz-insert-current-buffer-into-excel ()
  (interactive)
  (quiz-insert-into-excel (buffer-name (current-buffer)) t))
;;(quiz-insert-into-excel)

(cl-defun quiz-insert-into-excel (buffer &optional remove-source)
  ""
...
(cl-defun quiz-convert-to-csv (buffer &optional remove-source)
  ""
  (concat* (cl-loop for x in (quiz-parse-list buffer)
...
(cl-defun quiz-collect-qs (buffer)
...
(cl-defun quiz-trim-q-item-string (q-item-string)
