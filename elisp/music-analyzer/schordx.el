...
;;;; (cl-defun define-schord (schordx-method)...)

(cl-defun schordx-new (&optional (schosk (schosk-new)) (inversion 0) (root 0))
...
(cl-defun schordx-to-chordx (schordx &optional (reference-chrome (chrome-new)))
...
(cl-defun schordx-best-diminished (schordx reference-spitch)
...
(cl-defun schordx-to-chord (schordx &optional (reference-chrome (chrome-new)))
...
(cl-defun schordx-chord-type-group-p (schordx chord-type-group)
...
;; common short cuts
(cl-defun schordx-tonic-p (schordx)
...
(cl-defun schordx-dominant-p (schordx)
...
(cl-defun schordx-dominantic-p (schordx)
...
(cl-defun schordx-diminished-p (schordx)
...
(cl-defun schordx-dominantic-relation-p (x y)
...
;;; read/print
(cl-defun schordx-from-string (s &optional (style mu-default-print-style))
  (schordx-from-chordx (chordx-from-string s)))

(cl-defun schordx-to-string (schordx &optional (style mu-default-print-style))
