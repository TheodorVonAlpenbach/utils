...
(cl-defun chordx-new (&optional (chosk (chosk-new)) (inversion 0) (root (chrome-new)))
...
;;; properties
(cl-defun chordx-type (chordx)
  "Returns the classification of set chord SC"
  (schordx-type (schordx-from-chordx chordx)))


;;; print / write
(cl-defun chordx-to-string (chordx &optional (print-style mu-default-print-style))
...
(cl-defun chordx-from-string (s &optional (print-style mu-default-print-style))
