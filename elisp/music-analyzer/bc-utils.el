(cl-defun b1-legal-third-p (ibase mode &optional end-p)
...
(cl-defun b1-legal-start-or-end-interval (interval mode end-p cp-super-p)
...
(cl-defun cp-consonance-p (vinterval)
...
(cl-defun vppair2-parallel-motion (vppair1 vppair2)
...
(cl-defun vppairs-parallel-sequence-length (vppairs)
