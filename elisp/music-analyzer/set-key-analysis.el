...
(cl-defun sc-major-p (sc) (eql (sc-mode sc) 'major))
(cl-defun sc-minor-p (sc) (eql (sc-mode sc) 'minor))

(cl-defun sc-to-key (sc &optional (reference-key (make-key)))
...
(cl-defun set-tonicization (sc1 sc2 key)
