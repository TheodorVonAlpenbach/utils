...
(cl-defun ru-location (key) (cdr (assoc key +ru-locations+)))
...
(cl-defun stop-name (stop) (cdr (assoc 'Name stop)))
...
(cl-defun ru-get-travels (from to after &rest args)
