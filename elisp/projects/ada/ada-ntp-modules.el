...
(cl-defun ntp-module-codes-1 (user-descriptor)
  (emacsql db
...
(cl-defun ntp-module-codes-2 (user-descriptor gateway-descriptor)
  (emacsql db
...
(cl-defun ntp-module-codes (user-descriptor &optional gateway-descriptor)
