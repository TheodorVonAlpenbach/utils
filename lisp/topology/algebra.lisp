...
(defmethod add-geometry ((x point) (y point))
  (make-point (add-geometry (coordinates x)
			    (coordinates y))))
(defmethod add-geometry ((x point) (y segment))
  (make-segment (add-geometry x (start y))
		(add-geometry x (end y))))
(defmethod add-geometry ((x segment) (y segment))
  (make-segment (add-geometry (start x) (start y))
		(add-geometry (end x) (end y))))
(defmethod add-geometry ((x segment) y)
  (make-segment (add-geometry (start x) y)
