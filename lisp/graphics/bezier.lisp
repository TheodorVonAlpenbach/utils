...
(defun linear-bezier (p0 p1 &key (n 10) (type 'list)) (a-b 0 1 :length n :key (B1 p0 p1)))
(defun quadratic-bezier (p0 p1 p2 &key (n 10) (type 'list)) (a-b 0 1 :length n :key (B2 p0 p1 p2)))
(defun cubic-bezier (p0 p1 p2 p3 &key (n 10) (type 'list)) (a-b 0 1 :length n :key (B3 p0 p1 p2 p3)))
